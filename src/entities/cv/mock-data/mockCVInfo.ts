...
export const mockCVParseResponse2: CVParseResponse = {
  status: "COMPLETED",
  parseResultId: "9968ae8c-e8f4-4d36-a17a-79215cca669c",
  firstName: "Omar",
  lastName: "Mohamed",
  ...
  profile: {
    ...
    preferredJobTypes: [],
    yearsOfExperience: 0.3,
    linkedinUrl: "linkedin.com/in/omarmohamed",
    portfolioUrl: "omar.dev",
    githubUrl: "github.com/omarmohamed",
    cvEmail: "omarmohamed@gmail.com",
    noticePeriod: null,
    phone: "+20 120 456 2326",
    expectedSalary: null,
    summary:
  ...
  workExperiences: [
    {
      companyName: "under the stairs",
      description:
        "every thing with money, life with money, food with money, sleep with money, even love with money , all with money",
      isCurrent: false,
      startDate: "2025-05-01",
      jobTitle: "Words of love",
      location: "Remote",
      endDate: "2025-07-01",
    },
  ],
