...
import { useUpdateProfilePhoto } from "@/entities/company";

import { ACCEPTED_IMAGE_TYPES } from "@/shared";
import { ProfileImageProps } from "../types/componentsTypes";
...
export function ProfileImage({
  ...
  console.log(getInitialsFromFullName(name));
  return (
      ...
      <div className="relative w-24 h-24 rounded-full ring-4 ring-bg-surface overflow-hidden group">
        {!!profileImageUrl ? (
          <Image
            ...
            alt={name}
            fill
            className="object-cover bg-bg-muted"
          />
        ) : (
          <div
